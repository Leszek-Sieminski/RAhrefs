...
#'
#' @description Export additional metrics about the target, such as total # of referring domains, referring class C networks and referring IP addresses.
#'
...
#'
#' @examples
rah_metrics_extended <- function(target,
