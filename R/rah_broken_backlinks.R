#' Export the broken backlinks and details of the referring pages, such as anchor and page title.
#'
...
#'     error          \tab string  \tab + \tab + \tab The string indicating the nature of error (currently only "dns").
#'     }
#'
...
#'               \code{RAhrefs::rah_broken_backlinks(target = "ahrefs.com", token = "0123456789",
...
# b <- rah_broken_backlinks(target = "ahrefs.com", limit = 10)
# str(b)
