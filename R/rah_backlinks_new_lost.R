...
#'     first_seen     \tab date    \tab + \tab + \tab Date when the Ahrefs crawler was able to visit the backlink for the first time.                            \cr
...
#'     original       \tab boolean \tab + \tab + \tab Indicates whether the backlinks was present on the referring page when the Ahrefs crawler first visited it.\cr
...
#'               \code{RAhrefs::rah_backlinks_new_lost(target = "ahrefs.com", token = "0123456789",
