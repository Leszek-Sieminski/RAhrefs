#' Export the new or lost backlinks and details of the referring pages.
#'
#' @description Returns the new or lost backlinks and details of the referring pages.
#'
...
#'     in Details section
#' @param metrics character vector of columns to select. Possible metrics: date,	type,	ahrefs_rank,
#'     domain_rating,	url_from,	url_to,	links_internal,	links_external,	encoding,	http_code,	title,
#'     origin,	first_seen,	last_visited,	prev_visited,	original,	link_type,	redirect,	nofollow,	alt,
#'     anchor,	text_pre,	text_post.
...
# b <- rah_backlinks_new_lost(target = "ahrefs.com", limit = 10)
# str(b)
