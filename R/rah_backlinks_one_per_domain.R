...
#'     url_from_first_seen \tab date    \tab + \tab + \tab Least recent date when the Ahrefs crawler was able to visit the referring page with backlink.             \cr
#'     total_backlinks     \tab int     \tab - \tab + \tab Total number of backlinks from this referring domain.
#'     }
#'
...
#'
#' # downloading
#' b <- RAhrefs::rah_backlinks_one_per_domain(
#'   target   = "ahrefs.com",
#'   limit    = 2,
#'   where    = cond_where,
...
# b <- rah_backlinks_one_per_domain(target = "ahrefs.com", limit = 10)
# str(b)
