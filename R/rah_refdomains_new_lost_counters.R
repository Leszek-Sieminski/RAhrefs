...
#'     new        \tab int    \tab - \tab + \tab Total number of new referring domain.                                                          \cr
#'     lost       \tab int    \tab - \tab + \tab Total number of lost referring domain.                                                         \cr
#'     new_total  \tab int    \tab - \tab + \tab Total number of new referring domain when ignoring where filter.                               \cr
#'     lost_total \tab int    \tab - \tab + \tab Total number of lost referring domain when ignoring where filter.
#'     }
#'
...
#'               \code{RAhrefs::rah_refdomains_new_lost_counters(target = "ahrefs.com", token = "0123456789",
